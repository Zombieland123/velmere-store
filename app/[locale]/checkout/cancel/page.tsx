      ...
      <LuxurySection className="py-28 md:py-36">
        <section className="mx-auto max-w-3xl rounded-none border border-white/10 bg-white/[0.025] p-0 text-center shadow-[0_40px_140px_rgba(0,0,0,0.55)]">
          ...
          <div className="p-7 md:p-10">
            ...
            <p className="mt-6 font-mono text-[10px] uppercase tracking-[0.3em] text-velmere-gold/80">{t("cancelKicker")}</p>
            ...
            <div className="mx-auto mt-8 max-w-xl border-y border-white/5 py-4 font-mono text-[10px] uppercase tracking-[0.18em] text-white/42">
