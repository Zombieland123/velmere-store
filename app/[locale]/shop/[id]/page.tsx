  ...
  return (
    <main className="min-h-screen bg-velmere-black text-white">
      <LuxurySection className="py-24 md:py-32">
        <Link
          href="/shop"
          className="mb-8 inline-flex min-h-11 items-center gap-3 text-[11px] font-semibold uppercase tracking-[0.2em] text-white/50 transition-colors hover:text-white"
        >
            ...
            <div className="lg:sticky lg:top-28">
              ...
              <div className="mt-8">
                <div className="mb-4 flex items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    className="min-h-10 rounded-full border border-white/10 px-4 text-[10px] font-semibold uppercase tracking-[0.16em] text-white/50 transition-colors hover:border-white/25 hover:text-white"
                  >
                    {t("sizeGuide")}
                  </button>
                </div>
                ...
                <div className="flex flex-wrap gap-3">
                  {product.variants.map((variant) => (
                    <button
                      ...
                      className={`flex h-12 min-w-12 items-center justify-center rounded-full border px-3 text-xs font-semibold transition-colors ${
              ...
              {externalOnly ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-8 inline-flex min-h-14 w-full items-center justify-center gap-3 rounded-full bg-white px-6 text-[12px] font-semibold uppercase tracking-[0.22em] text-black transition-colors hover:bg-velmere-gold"
                >
                ...
                <button
                  ...
                  className="mt-8 inline-flex min-h-14 w-full items-center justify-center gap-3 rounded-full bg-white px-6 text-[12px] font-semibold uppercase tracking-[0.22em] text-black transition-colors hover:bg-velmere-gold disabled:cursor-not-allowed disabled:bg-white/10 disabled:text-white/32"
                >
