...
export function generateMetadata({ params: { locale } }: { params: { locale: string } }): Metadata {
  ...
  const description = locale === "pl"
    ? "Read-only architektura dostępu VLM, portfele i roadmap kontraktu bez logiki transakcyjnej."
    : locale === "de"
      ? "Read-only VLM Access Architektur, Wallets und Contract Roadmap ohne Transaktionslogik."
      : "Read-only VLM access architecture, wallets, and contract roadmap without transaction logic.";
