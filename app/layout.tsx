  ...
  return (
    <html lang="en" suppressHydrationWarning className="no-scrollbar overflow-x-clip antialiased [backface-visibility:hidden]">
      <body className="relative flex min-h-[100dvh] w-full flex-col overflow-x-hidden font-sans antialiased">
        ...
        <HtmlLangSync />
        <a href="#main-content" className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[9999] focus:rounded-full focus:bg-velmere-ivory focus:px-5 focus:py-3 focus:text-sm focus:font-semibold focus:text-black">Skip to content</a>
        {children}
      </body>
    </html>
  );
