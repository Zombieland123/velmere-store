...
export function buildHolderIntelligence(result: TokenRiskResult) {
  ...
  const nodes: HolderFlowNode[] = [
    ...
    },
    {
      ...
      note: dataCompleteness > 70 ? "Unknown bucket is limited." : "Missing holder data is treated as uncertainty, never as safety.",
  ...
  const lanes = [
    ...
    },
    {
      ...
      value: fdvGap !== undefined ? `${fdvGap.toFixed(2)}x FDV/MC` : "unknown",
    ...
    },
    {
      ...
      value: liquidityCoverage !== undefined ? `${liquidityCoverage.toFixed(2)}% liquidity/MC` : "unknown",
    ...
    },
    {
      ...
      value: volumePressure !== undefined ? `${volumePressure.toFixed(2)}% volume/MC` : "unknown",
  ...
  return {
    ...
    productionGates: [
      ...
      { id: "uncertainty-ui", label: "Uncertainty UI", status: "ready", fix: "Keep unknown wallets visible and never treat missing data as safety." },
    ...
    nextActions: [
      ...
      "Map top wallets into whales, CEX, DEX/LP, team, retail and unknown buckets.",
    ...
    visualPsychology: {
      ...
      trust: "Unknown wallets are shown as an explicit bucket; they never disappear into a positive score.",
