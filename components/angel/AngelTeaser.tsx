    ...
    <>
      {!hidden ? (
        <button
          ...
          className="group fixed bottom-[calc(env(safe-area-inset-bottom)+5.5rem)] right-4 z-[90] flex min-h-12 items-center gap-2 rounded-full border border-[#d4af37]/[0.35] bg-[#F5F0E8] px-3 text-black shadow-[0_20px_70px_rgba(0,0,0,0.55)] ring-1 ring-white/[0.20] backdrop-blur-2xl transition hover:border-[#d4af37]/[0.55] hover:bg-white active:scale-95 md:bottom-8 md:right-8 md:bg-[#1A1A1C]/[0.95] md:px-4 md:text-[#d4af37]"
        >
