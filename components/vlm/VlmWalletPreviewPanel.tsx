    ...
    <div className={`rounded-3xl border border-white/10 bg-white/[0.035] ${compact ? "p-5 md:p-6" : "p-6 md:p-8"}`}>
      <div className="flex items-start gap-5">
        ...
        <div className="min-w-0">
          ...
          <p className={`${compact ? "mt-3 text-xs leading-6" : "mt-4 text-sm leading-7"} font-sans text-white/60`}>
            {t("body")}
          </p>
        </div>
      </div>
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2">
        ...
        <button
          type="button"
          disabled
          className="flex min-h-12 cursor-not-allowed items-center justify-between rounded-full border border-white/12 px-5 font-sans text-[11px] font-semibold uppercase tracking-[0.16em] text-white/34"
        >
          Phantom
          <span className="text-[10px] text-white/30">{t("future")}</span>
        </button>
      </div>
      ...
      <div className="mt-6 rounded-2xl border border-white/10 bg-black/24 p-5">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-2 font-sans text-sm leading-6 text-white/70">{label}</p>
          </div>
      ...
      <button
        type="button"
        disabled
        className="mt-5 flex min-h-14 w-full cursor-not-allowed items-center justify-center gap-3 rounded-full border border-white/10 bg-black/24 px-6 font-sans text-[12px] font-semibold uppercase tracking-[0.2em] text-white/44"
      >
