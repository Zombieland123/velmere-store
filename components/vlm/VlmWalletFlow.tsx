      ...
      <div>
        ...
        <ol className="mt-5 grid gap-3">
          {steps.map((step, index) => (
            <li key={step} className="rounded-2xl border border-white/5 bg-white/[0.03] p-4">
              ...
              <p className="mt-2 font-sans text-xs leading-6 text-white/50">{t(`steps.${step}.body`)}</p>
            </li>
          ))}
        </ol>
      </div>
