...
const vlmDetailCopy = {
  en: {
    ...
    riskBody: "VLM is designed to organize eligibility for selected drops, archive previews, member rooms and Shield workflows. Access rules, supported features and technical status are shown directly in the product. It does not guarantee market value or uninterrupted availability.",
    faqKicker: "FAQ",
