...
export default function VlmTradeModalContent() {
  ...
  return (
    <div className="space-y-5">
      ...
      <label className="block rounded-2xl border border-white/[0.10] bg-[#121212]/[0.90] p-4">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <div className="rounded-xl border border-white/[0.10] p-4">
        ...
        <div className="rounded-xl border border-[#d4af37]/[0.20] bg-[#d4af37]/[0.06] p-4">
      ...
      <div className="grid gap-2 sm:grid-cols-2">
        <p className="rounded-xl border border-white/[0.05] p-3 text-xs text-white/[0.52]">{t("buyFeeExample")}</p>
        <p className="rounded-xl border border-white/[0.05] p-3 text-xs text-white/[0.52]">{t("sellFeeExample")}</p>
      </div>

      <p className="text-xs text-white/[0.48]">{t("lpNote")}</p>
      <p className="text-xs text-white/[0.48]">{t("impactNote")}</p>

      <button
        type="button"
        disabled
        className="flex min-h-11 w-full cursor-not-allowed items-center justify-center gap-2 rounded-full border border-white/[0.10] text-[10px] uppercase tracking-[0.16em] text-white/[0.42]"
      >
