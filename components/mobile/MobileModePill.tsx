...
export default function MobileModePill() {
  ...
  return (
    <div className="fixed left-1/2 z-[80] flex -translate-x-1/2 rounded-full border border-white/[0.10] bg-black/[0.70] p-1 shadow-[0_20px_80px_rgba(0,0,0,0.55)] backdrop-blur-2xl md:hidden safe-bottom-4">
      {items.map((item) => {
