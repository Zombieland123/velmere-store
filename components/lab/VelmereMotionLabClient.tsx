                ...
                <div className="mt-8 rounded-[1.25rem] border border-black/[0.10] bg-white/[0.86] p-4 shadow-xl">
                  <div className="grid gap-4 md:grid-cols-[0.92fr_1.08fr] md:items-center">
                    ...
                    <div>
                      ...
                      <button type="button" className="mt-5 inline-flex items-center gap-2 rounded-full bg-black px-4 py-3 font-mono text-[10px] uppercase tracking-[0.16em] text-white">Open concept <ArrowRight className="h-3.5 w-3.5" /></button>
                    </div>
                  </div>
                </div>
              </motion.div>
