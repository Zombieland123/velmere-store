...
export default function AuthGate({ children, title, body }: AuthGateProps) {
  ...
  return (
    <main className="relative min-h-[100dvh] overflow-hidden bg-velmere-black text-velmere-ivory">
      <section className="luxury-section pt-28 md:pt-32">
        <div className="grid gap-6 pb-20 lg:grid-cols-[0.9fr_0.82fr] lg:items-stretch">
          <section className="rounded-[2rem] border border-white/[0.10] bg-[#0B0B0D] p-6 shadow-velmere-card md:p-10">
          ...
          <aside className="rounded-[2rem] border border-white/[0.10] bg-[#111113] p-6 shadow-velmere-card md:p-8">
