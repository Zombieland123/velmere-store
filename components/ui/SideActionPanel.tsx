      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className={`fixed inset-x-0 bottom-0 z-[110] flex max-h-[88dvh] flex-col overflow-hidden rounded-t-[2rem] border border-white/10 bg-black/90 text-white shadow-[-24px_0_120px_rgba(0,0,0,0.55)] backdrop-blur-xl md:inset-y-0 md:right-0 md:left-auto md:h-dvh md:max-h-none md:w-full md:rounded-none md:rounded-l-[2rem] ${widthBySize[size]}`}
          >
            <div className="flex items-start justify-between gap-4 border-b border-white/5 px-6 py-6 md:px-10 md:py-8">
              ...
              <button
                type="button"
                onClick={onClose}
                className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-white/10 bg-white/[0.04] text-white/70 transition-colors hover:border-white/20 hover:text-white"
              >
