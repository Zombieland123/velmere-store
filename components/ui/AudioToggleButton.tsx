...
export default function AudioToggleButton() {
  ...
  return (
    <button
      ...
      className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-white/10 bg-[#151517] text-white/60 transition hover:border-white/25 hover:bg-[#1f1f22] hover:text-white active:scale-95"
    >
