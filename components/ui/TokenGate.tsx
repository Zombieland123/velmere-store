...
export default function TokenGate({ children, required = 10000, className = "" }: TokenGateProps) {
  ...
  return (
    <section className={`relative ${className}`} aria-live="polite">
      ...
      {!hasAccess ? (
        <div className="absolute inset-0 z-20 flex items-start justify-center rounded-[1.5rem] border border-[#c8a96a]/15 bg-[#050506]/45 p-4 backdrop-blur-[1px] md:items-center md:p-8">
          <div className="w-full max-w-xl rounded-2xl border border-[#c8a96a]/25 bg-[#1A1A1C]/95 p-5 text-center shadow-2xl shadow-black/50 md:p-7">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full border border-[#c8a96a]/30 bg-[#c8a96a]/10 text-[#c8a96a]">
            ...
            <button
              ...
              className="mt-5 inline-flex min-h-11 items-center justify-center gap-2 rounded-full border border-[#c8a96a]/30 bg-[#c8a96a]/10 px-5 font-mono text-[10px] font-black uppercase tracking-[0.18em] text-[#c8a96a] transition hover:bg-[#c8a96a]/15 active:scale-95"
            >
